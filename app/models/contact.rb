...
#  name                                          :string           default("")
#  name;email;phone_number;account_id;created_at :string(128)
#  phone_number                                  :string
#  created_at                                    :datetime         not null
#  updated_at                                    :datetime         not null
#  account_id                                    :integer          not null
#  name;email;identifier;phone_number;account_id :string(128)
#  name;email;phone_number;account_id            :string(128)
#
# Indexes
#
...
class Contact < ApplicationRecord
  ...
  validates :phone_number, allow_blank: true, format: { with: /\+[1-9]\d{1,14}\z/, message: I18n.t('errors.contacts.phone_number.invalid') }
