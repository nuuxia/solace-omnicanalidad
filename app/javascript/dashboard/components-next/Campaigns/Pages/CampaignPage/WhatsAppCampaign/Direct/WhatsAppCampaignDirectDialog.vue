...
import WhatsAppCampaignDirectForm from './WhatsAppCampaignDirectForm.vue';
...
<template>
  <div
    class="w-[1000px] z-50 min-w-0 absolute top-10 ltr:right-0 rtl:left-0 bg-n-alpha-3 backdrop-blur-[100px] p-6 rounded-xl border border-slate-50 dark:border-slate-900 shadow-md flex flex-col gap-6"
  >
    <!-- Encabezado: título y botón de sync -->
    <div class="flex items-center justify-between">
      <h3 class="text-base font-medium text-slate-900 dark:text-slate-50">
        {{ t('CAMPAIGN.WHATSAPP.CREATE.TITLE_DIRECT') }}
      </h3>
      <woot-button
    ...
    <WhatsAppCampaignDirectForm @submit="handleSubmit" @cancel="handleClose" />
  </div>
</template>
